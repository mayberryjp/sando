CONST_DEFAULT_CONFIGS = [
    ...
    (
        "BannedCountryList",
        "China,North Korea,Iran,Russia,Ukraine,Georgia,Armenia,Azerbaijan,Belarus,Syria,Venezuela,Cuba,Myanmar,Afghanistan",
    ),
    ("LocalNetworks", ""),
    ...
    ("SendDeviceClassificationsToHomelabApi", "0")("CollectorProcessingInterval", "60"),
