...
from src.database.services import get_all_services_database, insert_services_bulk
...
def get_all_services():
    ...
    try:
        ...
        log_info(
            logger,
            f"[INFO] Retrieved services for {len(services_dict)} ports from src.database.",
        )
